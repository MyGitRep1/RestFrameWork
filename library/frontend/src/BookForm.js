...
class BookForm extends React.Component {
    constructor(props) {
      super(props)
      this.state = {name: '', author: props: props.authors[0].id}
    }
   ...
   render() {
     return (
       <form onSubmit={(event:FormEvent<HTMLFromElement> )=> this.handleSubmit(event)}>
       ...
       <div className="form-group">
           ...
           <select name="author" className='form-control' onChange={(event:ChangeEvent<HTMLSelectElement> )=> this
